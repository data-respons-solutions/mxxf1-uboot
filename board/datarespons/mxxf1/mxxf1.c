...
iomux_v3_cfg_t const extra_nandf_pads[] = {
	MX6_PAD_NANDF_CS0__GPIO6_IO11		| MUX_PAD_CTRL(SLOWOUT_PAD_CTRL),	/* SPI_NOR_WP	*/
	MX6_PAD_NANDF_CS1__GPIO6_IO14		| MUX_PAD_CTRL(SLOWOUT_PAD_CTRL),	/* LAN2_EEWP	*/
	MX6_PAD_NANDF_CS2__GPIO6_IO15		| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* LCD_EN		*/
	MX6_PAD_NANDF_CS3__GPIO6_IO16		| MUX_PAD_CTRL(SLOWOUT_PAD_CTRL),	/* CAP_TCH_RST	*/

	MX6_PAD_NANDF_ALE__GPIO6_IO08		| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* CAP_TCH_INT	*/
	MX6_PAD_NANDF_CLE__GPIO6_IO07		| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* USBP3_OC		*/
	MX6_PAD_NANDF_WP_B__GPIO6_IO09		| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* USBP3_EN		*/
	MX6_PAD_NANDF_RB0__GPIO6_IO10		| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* AUX_5V_EN	*/

	MX6_PAD_NANDF_D2__GPIO2_IO02		| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* USBP1_OC		*/
	MX6_PAD_NANDF_D3__GPIO2_IO03		| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* USBP1_EN		*/

	MX6_PAD_NANDF_D4__GPIO2_IO04		| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* WDOG_PWR_EN	*/
	MX6_PAD_NANDF_D5__GPIO2_IO05		| MUX_PAD_CTRL(SLOWOUT_PAD_CTRL),	/* EMMC_RST#	*/
	MX6_PAD_NANDF_D6__GPIO2_IO06		| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* USBP2_OC		*/
	MX6_PAD_NANDF_D7__GPIO2_IO07		| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* USBP2_EN		*/
};

iomux_v3_cfg_t const extra_nvcc_gpio_pads[] = {
	MX6_PAD_KEY_COL0__GPIO4_IO06		| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* DIMM-	*/
	MX6_PAD_KEY_ROW0__GPIO4_IO07		| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* DIMM+	*/
	MX6_PAD_KEY_COL1__GPIO4_IO08		| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* TEMP_OS	*/

	MX6_PAD_KEY_COL2__GPIO4_IO10		| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* CODEC_PWR_EN	*/
	MX6_PAD_KEY_ROW2__GPIO4_IO11		| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* HDMI_CEC_IN	*/

	MX6_PAD_KEY_COL4__FLEXCAN2_TX		| MUX_PAD_CTRL(SLOWOUT_PAD_CTRL),	/* CAN2_TX	*/
	MX6_PAD_KEY_ROW4__FLEXCAN2_RX		| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* CAN2_RX	*/

	MX6_PAD_GPIO_0__CCM_CLKO1			| MUX_PAD_CTRL(PAD_CTL_DSE_40ohm | PAD_CTL_SPEED_HIGH),	/* AUD_MCLK	*/
	MX6_PAD_GPIO_1__WDOG2_B				| MUX_PAD_CTRL(SLOWOUT_PAD_CTRL),	/* WDOG_B		*/
	MX6_PAD_GPIO_2__GPIO1_IO02			| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* BLON_3V_H	*/

	MX6_PAD_GPIO_4__GPIO1_IO04			| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* TCH_PWRON	*/
	MX6_PAD_GPIO_5__GPIO1_IO05			| MUX_PAD_CTRL(SLOWOUT_PAD_CTRL),	/* EEPROM_WP	*/
	MX6_PAD_GPIO_7__FLEXCAN1_TX			| MUX_PAD_CTRL(SLOWOUT_PAD_CTRL),	/* CAN1_TX	*/

	MX6_PAD_GPIO_8__FLEXCAN1_RX			| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* CAN1_RX		*/
#ifdef USE_PWM_FOR_BL
	MX6_PAD_GPIO_9__PWM1_OUT			| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/*  BL_PWM		*/
#else
	MX6_PAD_GPIO_9__GPIO1_IO09			| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),
#endif
	MX6_PAD_GPIO_17__GPIO7_IO12			| MUX_PAD_CTRL(SLOWOUT_PAD_CTRL),	/* PCIE_RST	*/
	MX6_PAD_GPIO_18__GPIO7_IO13			| MUX_PAD_CTRL(PAD_CTL_HYS | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN),	/* PMIC_INT_B	*/

};

iomux_v3_cfg_t const extra_pads[] = {
	MX6_PAD_ENET_RX_ER__GPIO1_IO24		| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* USB_OTG_ID	*/
	MX6_PAD_ENET_RXD0__GPIO1_IO27		| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* UOK_B		*/
	MX6_PAD_ENET_TXD1__GPIO1_IO29		| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* USB_H1_PWR_EN	*/
	MX6_PAD_SD1_CMD__GPIO1_IO18			| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* FAN_EN		*/
	MX6_PAD_SD1_DAT1__PWM3_OUT			| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* BUZ_INT_EN	*/
	MX6_PAD_SD1_DAT2__GPIO1_IO19		| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* BUZ_EXT_EN	*/

	MX6_PAD_CSI0_DATA_EN__GPIO5_IO20	| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* PCIE_WAKE_B	*/

	MX6_PAD_EIM_D21__GPIO3_IO21			| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* USB_OTG_OC		*/
	MX6_PAD_EIM_D22__GPIO3_IO22			| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* USB_ORG_PWR_EN	*/
	MX6_PAD_EIM_D29__GPIO3_IO29			| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* PWR_BTN_SNS		*/
	MX6_PAD_EIM_D30__GPIO3_IO30			| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* USB_H1_OC		*/
	MX6_PAD_EIM_D31__GPIO3_IO31			| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* USB_P0_OC		*/
	MX6_PAD_EIM_D28__GPIO3_IO28			| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* USBP0_EN			*/

	MX6_PAD_EIM_D23__GPIO3_IO23			| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* LAN2_DEV_OFF#	*/
	MX6_PAD_EIM_D24__GPIO3_IO24			| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* LAN2_SMB_ALRT#	*/
	MX6_PAD_GPIO_16__GPIO7_IO11			| MUX_PAD_CTRL(OUT_LOW_PAD_CTRL),	/* LVDS_ROTATE		*/

};

iomux_v3_cfg_t const audio_pads[] = {
	MX6_PAD_CSI0_DAT4__AUD3_TXC		| MUX_PAD_CTRL(SLOWOUT_PAD_CTRL),	/* AUD3_TXC		*/
	MX6_PAD_CSI0_DAT5__AUD3_TXD		| MUX_PAD_CTRL(SLOWOUT_PAD_CTRL),	/* AUD3_TXD		*/
	MX6_PAD_CSI0_DAT6__AUD3_TXFS	| MUX_PAD_CTRL(SLOWOUT_PAD_CTRL),	/* AUD3_TXFS	*/
	MX6_PAD_CSI0_DAT7__AUD3_RXD		| MUX_PAD_CTRL(REGINP_PAD_CTRL),	/* AUD3_RXD		*/
};

iomux_v3_cfg_t const enet_pads[] = {
	MX6_PAD_ENET_MDIO__ENET_MDIO		| MUX_PAD_CTRL(ENET_PAD_CTRL_UP),
	MX6_PAD_ENET_MDC__ENET_MDC			| MUX_PAD_CTRL(ENET_PAD_CTRL_UP),
	MX6_PAD_RGMII_TXC__RGMII_TXC		| MUX_PAD_CTRL(ENET_PAD_CTRL_DN),
	MX6_PAD_RGMII_TD0__RGMII_TD0		| MUX_PAD_CTRL(ENET_PAD_CTRL_DN),
	MX6_PAD_RGMII_TD1__RGMII_TD1		| MUX_PAD_CTRL(ENET_PAD_CTRL_DN),
	MX6_PAD_RGMII_TD2__RGMII_TD2		| MUX_PAD_CTRL(ENET_PAD_CTRL_DN),
	MX6_PAD_RGMII_TD3__RGMII_TD3		| MUX_PAD_CTRL(ENET_PAD_CTRL_DN),
	...
	MX6_PAD_RGMII_RXC__RGMII_RXC		| MUX_PAD_CTRL(ENET_PAD_CTRL_DN),
	MX6_PAD_RGMII_RD0__RGMII_RD0		| MUX_PAD_CTRL(ENET_PAD_CTRL_DN),
	MX6_PAD_RGMII_RD1__RGMII_RD1		| MUX_PAD_CTRL(ENET_PAD_CTRL_DN),
	MX6_PAD_RGMII_RD2__RGMII_RD2		| MUX_PAD_CTRL(ENET_PAD_CTRL_DN),
	MX6_PAD_RGMII_RD3__RGMII_RD3		| MUX_PAD_CTRL(ENET_PAD_CTRL_DN),
	MX6_PAD_RGMII_RX_CTL__RGMII_RX_CTL	| MUX_PAD_CTRL(ENET_PAD_CTRL_DN),
	/* AR8031 PHY Reset */
	MX6_PAD_ENET_CRS_DV__GPIO1_IO25		| MUX_PAD_CTRL(ENET_PAD_CTRL_UP),
	MX6_PAD_ENET_TX_EN__GPIO1_IO28		| MUX_PAD_CTRL(ENET_PAD_CTRL_UP), 	/* ENET_WOL_INT (low)	*/
	MX6_PAD_ENET_RXD1__GPIO1_IO26		| MUX_PAD_CTRL(ENET_PAD_CTRL_UP), 	/* RGMII_INT (low)	*/
};
...
iomux_v3_cfg_t const usdhc3_pads[] = {
	...
	MX6_PAD_NANDF_D0__GPIO2_IO00    | MUX_PAD_CTRL(REGINP_PAD_CTRL), 		/* CD 				*/
	MX6_PAD_NANDF_D1__GPIO2_IO01    | MUX_PAD_CTRL(REGINP_PAD_CTRL),		/* WP 				*/
	MX6_PAD_SD3_RST__GPIO7_IO08	  | MUX_PAD_CTRL(REGINP_PAD_CTRL),		/* HEADPHONE_DET	*/
};
...
iomux_v3_cfg_t const usdhc4_pads[] = {
	...
	MX6_PAD_NANDF_D5__GPIO2_IO05    | MUX_PAD_CTRL(USDHC_PAD_CTRL),	/* eMMC reset */
};
