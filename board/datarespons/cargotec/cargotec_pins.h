...
static iomux_v3_cfg_t const hw_settings_pads[] = {
	IOMUX_PADS(PAD_DISP0_DAT0__GPIO4_IO21	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* HW_Setting 0*/
	IOMUX_PADS(PAD_DISP0_DAT1__GPIO4_IO22	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* HW Setting 1 */
	IOMUX_PADS(PAD_DISP0_DAT2__GPIO4_IO23	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* HW Setting 2 */
};

static iomux_v3_cfg_t const otg_pads[] = {
	IOMUX_PADS(PAD_EIM_D22__USB_OTG_PWR 	| MUX_PAD_CTRL(NO_PAD_CTRL)),
	IOMUX_PADS(PAD_KEY_ROW1__GPIO4_IO09 	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* Note that this is not default, need DT config */
	IOMUX_PADS(PAD_ENET_RX_ER__USB_OTG_ID 	| MUX_PAD_CTRL(NO_PAD_CTRL)),
};

static iomux_v3_cfg_t const can1_pads[] = {
	IOMUX_PADS(PAD_KEY_COL2__GPIO4_IO10	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_CAN1_EN */
	IOMUX_PADS(PAD_KEY_COL3__GPIO4_IO12	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_CAN1_STB */
	IOMUX_PADS(PAD_EIM_D31__GPIO3_IO31		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_CAN1_RES_EN */
	IOMUX_PADS(PAD_GPIO_7__FLEXCAN1_TX		| MUX_PAD_CTRL(NO_PAD_CTRL)),
	IOMUX_PADS(PAD_GPIO_8__FLEXCAN1_RX		| MUX_PAD_CTRL(NO_PAD_CTRL)),
	IOMUX_PADS(PAD_DI0_PIN2__GPIO4_IO18	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_CAN1_WAKE */
};

static iomux_v3_cfg_t const can2_pads[] = {
	IOMUX_PADS(PAD_GPIO_9__GPIO1_IO09		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_CAN2_EN */
	IOMUX_PADS(PAD_GPIO_2__GPIO1_IO02		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_CAN2_STB */
	IOMUX_PADS(PAD_GPIO_6__GPIO1_IO06		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_CAN2_RES_EN */
	IOMUX_PADS(PAD_KEY_COL4__FLEXCAN2_TX	| MUX_PAD_CTRL(NO_PAD_CTRL)),
	IOMUX_PADS(PAD_KEY_ROW4__FLEXCAN2_RX	| MUX_PAD_CTRL(NO_PAD_CTRL)),
	IOMUX_PADS(PAD_DI0_PIN3__GPIO4_IO19	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_CAN2_WAKE */
};

static iomux_v3_cfg_t const wwan_pads[] = {
	IOMUX_PADS(PAD_DISP0_DAT5__GPIO4_IO26	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_EN_PWR--ANT_GPS */
	IOMUX_PADS(PAD_DISP0_DAT6__GPIO4_IO27	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_nPRST_WWAN */
	IOMUX_PADS(PAD_DISP0_DAT7__GPIO4_IO28	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_nDISABLE_WWAN   */
	IOMUX_PADS(PAD_DISP0_DAT8__GPIO4_IO29	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_nWAKE_L--WWAN   */
	IOMUX_PADS(PAD_DISP0_DAT9__GPIO4_IO30	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* LED_nWWAN   */
};

static iomux_v3_cfg_t const other_pads[] = {
	IOMUX_PADS(PAD_KEY_COL1__GPIO4_IO08	| MUX_PAD_CTRL(ENET_PAD_CTRL_UP)),	/* GP_NRESET_TPM */
	IOMUX_PADS(PAD_GPIO_4__GPIO1_IO04		| MUX_PAD_CTRL(ENET_PAD_CTRL_UP)),	/* GP_NRST_MCU1 */
	...
	IOMUX_PADS(PAD_EIM_D23__GPIO3_IO23		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP--WL_BAT_PWR_EN */
	...
	IOMUX_PADS(PAD_DI0_PIN15__GPIO4_IO17	| MUX_PAD_CTRL(INPUT_PD_PAD_CTRL)),		/* MCU Boot0 */
	IOMUX_PADS(PAD_DISP0_DAT3__GPIO4_IO24	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_EN--GPO1  */
	IOMUX_PADS(PAD_DISP0_DAT4__GPIO4_IO25	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_EN--GPO2  */
	IOMUX_PADS(PAD_DISP0_DAT21__GPIO5_IO15	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* EN_ANI_1 */
	IOMUX_PADS(PAD_DISP0_DAT22__GPIO5_IO16	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* EN_ANI_2 */
	IOMUX_PADS(PAD_DISP0_DAT10__GPIO4_IO31 | MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_Status--CPU */
};
