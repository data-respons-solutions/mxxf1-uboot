...
#define PU_47K_LOWSPEED (PAD_CTL_PUS_47K_UP | PAD_CTL_PUE | PAD_CTL_SPEED_LOW)
#define PD_100K_LOWSPEED (PAD_CTL_PUS_100K_DOWN | PAD_CTL_PUE | PAD_CTL_SPEED_LOW)
#define PD_100K_LOWSPEED_STRONG (PD_100K_LOWSPEED | PAD_CTL_DSE_40ohm)
#define PAD_CTL_LS_STRONG (PAD_CTL_SPEED_LOW | PAD_CTL_DSE_40ohm )
