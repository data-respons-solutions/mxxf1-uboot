...
int board_late_init(void)
{
	...
	{
	case 0:
		env_set("fdt_file", "/boot/laerdal-cpu-module-revA.dtb");
		break;

	case 1:
		env_set("fdt_file", "/boot/laerdal-cpu-module-revB.dtb");
		break;

	default:
		if (is_mx6dl())
			env_set("fdt_file", "/boot/laerdal-cpu-module-revC-dl.dtb");
		else
			env_set("fdt_file", "/boot/laerdal-cpu-module-revC-q.dtb");
		break;
	}
