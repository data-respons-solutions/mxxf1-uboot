...
static iomux_v3_cfg_t const ecspi1_pads[] = {
	...
	IOMUX_PADS(PAD_EIM_D19__GPIO3_IO19 	| MUX_PAD_CTRL(REGINP_PAD_CTRL)),	/* Use GPIO for CS 	*/
};
...
static iomux_v3_cfg_t const revb_pads[] = {
	IOMUX_PADS(PAD_DISP0_DAT18__GPIO5_IO12 		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* ECSPI2 CS */
	...
	IOMUX_PADS(PAD_DISP0_DAT22__GPIO5_IO16 		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_01--PMU (irq)*/
	IOMUX_PADS(PAD_DISP0_DAT23__GPIO5_IO17 		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP_02--PMU (Status) */
};

static iomux_v3_cfg_t const revc_pads[] = {
	IOMUX_PADS(PAD_GPIO_6__GPIO1_IO06				| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* MIC DETECT */
	IOMUX_PADS(PAD_DISP0_DAT22__GPIO5_IO16 		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* START_ADAPTER */
	IOMUX_PADS(PAD_DISP0_DAT23__GPIO5_IO17 		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* START_KEY */
	IOMUX_PADS(PAD_KEY_ROW4__GPIO4_IO15			| MUX_PAD_CTRL(INPUT_PD_PAD_CTRL)),		/* PCU clr signal */
};

static iomux_v3_cfg_t const rgb_pads[] = {
	IOMUX_PADS(PAD_DI0_DISP_CLK__IPU1_DI0_DISP_CLK | MUX_PAD_CTRL(0x10)),
	...
	IOMUX_PADS(PAD_ENET_TXD0__GPIO1_IO30			| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* LCD_EN */
	IOMUX_PADS(PAD_KEY_COL1__GPIO4_IO08			| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* BL_EN */
	IOMUX_PADS(PAD_GPIO_7__GPIO1_IO07				| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP--LCD_L/R */
	IOMUX_PADS(PAD_GPIO_8__GPIO1_IO08				| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP--LCD_U/D */
};
...
static iomux_v3_cfg_t const usb_otg_pads[] = {
	...
	IOMUX_PADS(PAD_ENET_RX_ER__USB_OTG_ID 	| MUX_PAD_CTRL(REGINP_PAD_CTRL)),
};

static iomux_v3_cfg_t const hw_settings_pads[] = {
	IOMUX_PADS(PAD_EIM_D27__GPIO3_IO27		| MUX_PAD_CTRL(REGINP_PAD_CTRL)),	/* HW_Setting_0 */
	IOMUX_PADS(PAD_EIM_D28__GPIO3_IO28		| MUX_PAD_CTRL(REGINP_PAD_CTRL)),	/* HW_Setting_1 */
	IOMUX_PADS(PAD_KEY_ROW2__GPIO4_IO11	| MUX_PAD_CTRL(INPUT_PD_PAD_CTRL)),	/* HW_Setting_2 */
};

static iomux_v3_cfg_t const other_pads[] = {
	IOMUX_PADS(PAD_NANDF_CLE__GPIO6_IO07	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP--BT_HOST_WAKE */
	IOMUX_PADS(PAD_GPIO_4__GPIO1_IO04		| MUX_PAD_CTRL(REGINP_PAD_CTRL)),/* Function key (active low) */
	IOMUX_PADS(PAD_KEY_COL2__GPIO4_IO10	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* Touch reset (low)	*/
	IOMUX_PADS(PAD_KEY_ROW1__GPIO4_IO09	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* AUX_5V_EN */

	IOMUX_PADS(PAD_KEY_COL4__GPIO4_IO14	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP--Charger_nCE */
	...
	IOMUX_PADS(PAD_GPIO_9__GPIO1_IO09		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP--HP_DET */
	IOMUX_PADS(PAD_GPIO_18__GPIO7_IO13		| MUX_PAD_CTRL(PAD_CTL_ODE | PAD_CTL_PUS_100K_UP | PAD_CTL_PUE)),	/* GP--CTP_nINT (touch interrupt */
	...
	IOMUX_PADS(PAD_NANDF_D1__GPIO2_IO01	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* ACCL_INT_IN */
	...
	IOMUX_PADS(PAD_EIM_D23__GPIO3_IO23		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* GP--CHarger_ISET */
	...
	IOMUX_PADS(PAD_SD1_DAT2__GPIO1_IO19	| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* PWM2--CPU (vib) */
	IOMUX_PADS(PAD_SD1_DAT3__PWM1_OUT		| MUX_PAD_CTRL(NO_PAD_CTRL)),	/* PWM_DISP0_BL (backlight) */
...
static struct i2c_pads_info i2c_pad_info0 = {
		.scl = {
			.i2c_mode = IOMUX_PADS(PAD_CSI0_DAT9__I2C1_SCL | MUX_PAD_CTRL(I2C_PAD_CTRL)),
			.gpio_mode = IOMUX_PADS(PAD_CSI0_DAT9__GPIO5_IO27 | MUX_PAD_CTRL(I2C_PAD_CTRL)),
			.gp = IMX_GPIO_NR(5, 27)
		},
		.sda = {
			.i2c_mode = IOMUX_PADS(PAD_CSI0_DAT8__I2C1_SDA | MUX_PAD_CTRL(I2C_PAD_CTRL)),
			.gpio_mode = IOMUX_PADS(PAD_CSI0_DAT8__GPIO5_IO26 | MUX_PAD_CTRL(I2C_PAD_CTRL)),
			.gp = IMX_GPIO_NR(5, 26)
		}
	};
...
static struct i2c_pads_info i2c_pad_info2 = {
	.scl = {
		.i2c_mode = IOMUX_PADS(PAD_GPIO_3__I2C3_SCL | MUX_PAD_CTRL(I2C_PAD_CTRL)),
		.gpio_mode = IOMUX_PADS(PAD_GPIO_3__GPIO1_IO03 | MUX_PAD_CTRL(I2C_PAD_CTRL)),
		.gp = IMX_GPIO_NR(1, 3)
	},
	.sda = {
		.i2c_mode = IOMUX_PADS(PAD_GPIO_16__I2C3_SDA | MUX_PAD_CTRL(I2C_PAD_CTRL)),
		.gpio_mode = IOMUX_PADS(PAD_GPIO_16__GPIO7_IO11 | MUX_PAD_CTRL(I2C_PAD_CTRL)),
		.gp = IMX_GPIO_NR(1, 6)
	}
};
