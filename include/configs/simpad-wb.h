...
#ifndef __SIMPAD_WB_CONFIG_H
#define __SIMPAD_WB_CONFIG_H
...
#define CONFIG_DEFAULT_FDT_FILE	"/boot/dr-wandboard.dtb"
...
#define CONFIG_BOOTCOMMAND \
	...
	"else " \
		"mmc rescan; run setmmc; echo booting from MMC ...;" \
	"fi; " \
	"run loadbootscript;" \
	"run bootscript;" \
